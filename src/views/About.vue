...
.contact-card { display:grid; grid-template-columns: 1fr; gap:0; border-radius: 4px; overflow:hidden; margin-bottom:24px; background:#fff; }
...
.contact-card .map img { display:block; width:100%; height:auto; }
